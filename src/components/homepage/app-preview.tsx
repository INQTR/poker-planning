  ...
  return (
    <div className="bg-background py-24">
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-900 dark:bg-card px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-20 xl:px-24 ring-1 ring-white/10">
          ...
          >
            <GradientBlob className="w-[72.1875rem]" />
          </div>
        </div>
      </div>
    </div>

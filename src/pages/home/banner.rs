...
pub fn Banner() -> impl IntoView {
    view! {
        <div class="z-50 relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
            <div
            ...
            <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
                <p class="text-sm/6 text-gray-900">We stand with Ukraine and its people</p>
                <a
